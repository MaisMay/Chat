...
public class ChatServer implements TCPConnectionListener {
    ...
    private ChatServer () {
        ...
        try (ServerSocket serverSocket = new ServerSocket(8189)){ // слушает порт, принимает соединение
            while(true) { // бесконечный цикл в методе ассепт
                try {
                 new TCPConnection(this, serverSocket.accept()); // ждет и возвращает обьект сокет
